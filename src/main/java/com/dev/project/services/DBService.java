...
public class DBService {
	...
	public void instantiateTestDabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "projectbackend2020@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA, pe.encode("cadeira123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "ivansimplicio97@gmail.com", "72278633015", TipoCliente.PESSOA_FISICA, pe.encode("cadeira123"));
